			...
			<div className="container flex flex-col items-center gap-12 relative">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
					...
					<div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
						...
						<strong className="text-gray-100 text-heading-sm">Personalize seu site</strong>
					...
					<div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
						...
						<strong className="text-gray-100 text-heading-sm">Venda de qualquer loja</strong>
						<p className="text-body-sm text-gray-200">
					...
					<div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
						...
						<strong className="text-gray-100 text-heading-sm">Receba suporte amigável</strong>
						<p className="text-body-sm text-gray-200">
